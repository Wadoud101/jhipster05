  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex05App.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="ex05App.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex05App.country.countryName')}
                id="country-countryName"
                name="countryName"
                data-cy="countryName"
                type="text"
              />
              <ValidatedField id="country-region" name="region" data-cy="region" label={translate('ex05App.country.region')} type="select">
                <option value="" key="0" />
                {regions
